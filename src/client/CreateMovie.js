        ...
        return (
            <div className="is-fluid">
                ...
                <form onSubmit={this.handleSubmit}>
                    <h2 className="title is-1 has-text-primary">Create New movie</h2>
                    <hr />
                    ...
                    <div className="columns">
                        <div className="column is-half">
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input is-small" type="number" name="duration" value={this.state.duration} onChange={this.handleChange} id="form" />
                                </div>
                            </div>
                             <div className="field">
